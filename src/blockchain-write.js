 ...
 * Uporablja znane Anvil dev ključe za račune #0–#2 (proizvajalec, distributer, lekarna).
 */
...
const ANVIL_DEV_KEYS = new Map([
    ['0xf39fd6e51aad88f6f4ce6bbfc8148c71ab6b8f2', '0xac0974bec39a17e36ba4a6b4d238ff944bacb478cbed5efcae784d7bf4f2ff80'],
    ['0x70997970c51812dc3a010c7d01b50b0d17dc79c8', '0x59c6995e998f97a5a0044966f0945389dc9e86dae88c7a8412f4603b6b78690d'],
    ['0x3c44cde03357a55cdfc9c5bd83b17e81f55852e4', '0x5de4111afa1a4b94908f83103eb1f1706367c2e68ca870fc3fb9a804cdab365a']
]);
...
export async function registerMedicineServer(walletAddress, medicineId, ipfsHash) {
    if (!canAutoSignForWallet(walletAddress)) {
        return { skipped: true };
    }
    if (!(await isContractDeployed())) {
